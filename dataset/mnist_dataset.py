...
class MnistDataset(Dataset):
    def __init__(self, split, im_path, im_size=28, im_channels=1, im_ext='png'):
        r"""
        This initialization method is used to set up the dataset.
        :split tells whether the data is for training or testing.
        :im_path is the main folder where the images are stored.
        :im_ext is the image file type, assuming all images have the same extension.
        """
        self.split = split
    ...
    def load_images(self, im_path):
        r"""
        Gets all images and stacks them all.
        """
